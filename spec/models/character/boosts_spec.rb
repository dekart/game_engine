...
describe Character::Boosts do
  ...
  describe 'active' do
    ...
    it 'should have active fight boost' do
      ...
      @character.active_boosts.should == {'fight' => {'attack' => @fight_attack_boost.id}}
    end
    
    it 'should have active defence boost' do
      @character.activate_boost!(@fight_defence_boost, 'defence')
      
      @character.active_boosts.should == {'fight' => {'defence' => @fight_defence_boost.id}}
    end
    
    it 'should deactivate fight boost' do
      @character.activate_boost!(@fight_attack_boost, 'attack')
      @character.deactivate_boost!(@fight_attack_boost, 'attack')
      
      @character.active_boosts.should == {'fight' => {}}
    end
    
    it 'should have active boost after toggle' do
      @character.toggle_boost!(@fight_attack_boost, 'attack')
    ...
    it 'should have two active boosts different types' do
      ...
      @character.active_boosts.should == {'fight' => {'attack' => @fight_attack_boost.id, 'defence' => @fight_defence_boost.id}}
    end
    ...
    it 'should not have more than one active same type boosts' do
      ...
      @character.activate_boost!(@fight_attack_boost, 'attack')
      @character.activate_boost!(another_attack_boost, 'attack')
    ...
    it 'should select boosts for monster attack' do
      ...
      @character.active_boosts.should == {'monster' => {'attack' => @monster_attack_boost.id}}
    end
    ...
    it 'should activate all type of boosts' do
      ...
      @character.active_boosts.should == {
        'fight' => {'attack' => @fight_attack_boost.id, 'defence' => @fight_defence_boost.id}, 
        'monster' => {'attack' => @monster_attack_boost.id}
      }
    end
