      ...
      class Collection
        ...
        def sell!(item, amount = 1)
          ...
          if effective_amount > 0
            ...
            deposit_character(item, effective_amount)
        ...
        protected
          ...
          def charge_character(item, amount)
            character.charge(item.basic_price * amount, item.vip_price * amount, item)
          end
          
          def deposit_character(item, amount)
            character.charge(- item.sell_price * amount, 0, item)
          end
