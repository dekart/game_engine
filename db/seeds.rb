...
ActiveRecord::Base.transaction do
  [MissionGroup, Mission, MonsterType, ItemGroup, Item, Boss, PropertyType, CharacterType, Tip, AchievementType, CreditPackage, HelpPage, ItemCollection].each do |model|
